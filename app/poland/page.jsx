          ...
          <div class="px-8 py-6 bg-sky-50 flex-col justify-start items-start gap-2.5 inline-flex">
            <div class="justify-start items-start sm:items-center gap-[23px] flex flex-col sm:flex-row">
              <div class="w-[69px] h-[69px] relative">
                ...
                >
                  <path
                    d="M35 31.354C31.3758 31.354 28.4375 34.2923 28.4375 37.9165C28.4375 41.5408 31.3758 44.479 35 44.479C38.6243 44.479 41.5625 41.5408 41.5625 37.9165C41.5625 34.2923 38.6243 31.354 35 31.354Z"
                    fill="#07294D"
                  />
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M11.6667 13.6919V54.5251C11.6667 59.3577 15.5842 63.2751 20.4167 63.2751H49.5834C54.416 63.2751 58.3334 59.3577 58.3334 54.5251V25.3586C58.3334 20.5261 54.416 16.6086 49.5834 16.6086H14.5834C12.9725 16.6086 11.6667 15.3027 11.6667 13.6919ZM35 26.9792C28.9594 26.9792 24.0625 31.876 24.0625 37.9167C24.0625 43.9574 28.9594 48.8542 35 48.8542C41.0407 48.8542 45.9375 43.9574 45.9375 37.9167C45.9375 31.876 41.0407 26.9792 35 26.9792Z"
                    fill="#07294D"
                  />
                  <path
                    d="M52.5 11.6679V17.1065C51.5877 16.7841 50.6059 16.6086 49.5833 16.6086H14.5834C12.9725 16.6086 11.6667 15.3028 11.6667 13.692V13.4848C11.6667 11.9301 12.8098 10.6121 14.3488 10.3922L45.8418 5.89322C49.3558 5.39118 52.5 8.11806 52.5 11.6679Z"
                    fill="#123E6C"
                  />
                </svg>
              </div>
