...
function Slider() {
  ...
  return (
    <div className="w-full relative bg-[#07294D] flex  justify-center mb-10  ">
      <div
        data-aos="zoom-in"
        className=" max-w-7xl flex flex-col gap-4 md:gap-10 relative w-full justify-center items-center   py-[20px] px-[1px] md:py-[50px]"
      >
              ...
              return (
                <SwiperSlide>
                  <div className=" z-40 flex flex-col gap-4 md:flex-row ">
                    <div className="flex flex-col md:flex-row items-center gap-4 w-full bg-[#08305A] p-6 rounded-lg min-h-[40vh]">
                      {/* <svg
                        width="32"
                        height="32"
                        viewBox="0 0 32 32"
                      ...
                      <div className="flex flex-col">
                        ...
                        <p className="text-[12px] font-light text-white max-w-[400px]">
                          {item.comment}
                        </p>
                        <div className="flex flex-col ">
